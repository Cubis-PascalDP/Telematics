 ...
 *     <li>--X: <a href="http://api.fm-web.co.uk/webservices/AssetDataWebSvc/RecordedEventProcessesWS.asmx?op=GetVehicleEventsXMostRecent">GetVehicleEventsXMostRecent</a></li>
 * </ul>
...
public class ProcessRecordedEvents extends RecordedEvents {
    ...
    public boolean parseArguments() {
        ...
        if ((vehicle != null) && (vehicles != null)) {
            System.err.println("--vehicle and --vehicles should not used together.");
            return false;
        }
